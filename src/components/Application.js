...
const Application = (props) => {
  return (
    <div className="application">
      <div className="application-personal">
        <h1 className="info-name">{props.applicationInfo.name}</h1>
        <p className="container-email-phone">
          <span className="info-email">{props.applicationInfo.email}</span>
          <span className="info-phone">{props.applicationInfo.phone}</span>
        </p>
      </div>
      <h4 className="application-title">education</h4>
      <div className="application-education">
        <h4 className="info-school">{props.applicationInfo.school}</h4>
        <div className="container-major-date">
          <span className="info-major">{props.applicationInfo.major}</span>
          <span className="info-school-date">{props.applicationInfo.date}</span>
        </div>
      </div>
      <h4 className="application-title">experience</h4>
      <div className="application-experience">
        <h4 className="info-company">{props.applicationInfo.company}</h4>
        <div className="container-position-date">
          <span className="info-position">
            {props.applicationInfo.position}
          </span>
          <div>
            <span className="info-date-from">
              {props.applicationInfo.dateFrom}
            </span>
            <span> - </span>
            <span className="info-date-to">{props.applicationInfo.dateTo}</span>
          </div>
        </div>
        <p className="info-job-description">
          {props.applicationInfo.jobDescription}
        </p>
      </div>
